			  ...
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Descrizioone:</dt>
					    ...
					    <div class='card-footer'>
					   		<a href="${pageContext.request.contextPath}/cartellaEsattoriale/remove/${idCartella}" class='btn btn-outline-primary' style='width:100px'>
