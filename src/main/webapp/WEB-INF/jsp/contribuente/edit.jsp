					...
					<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<form:form modelAttribute="edit_contribuente_attr"  method="post" action="${pageContext.request.contextPath }/contribuente/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									<label for="codiceFiscale" class="form-label">CodiceFiscale <span class="text-danger">*</span></label>
									<spring:bind path="codiceFiscale">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="codiceFiscale" id="codiceFiscale" placeholder="Inserire il coodiceFiscale" value="${edit_contribuente_attr.codiceFiscale }" required>
									</spring:bind>
